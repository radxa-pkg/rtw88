...
#define EEPROM_DEFAULT_RFE_OPTION		0x00	// error message: rfe 4/11 isn't supported
#define	EEPROM_RF_BOARD_OPTION_8723D		0x29
#define EEPROM_Default_CrystalCap_8723D		0x24
#define	EEPROM_2G_5G_PA_TYPE_8723D		0x00
#define EEPROM_DEFAULT_CHANNEL_PLAN		0x20
#define	EEPROM_RF_BT_SETTING_8723D		0x11
#define	EEPROM_Default_ThermalMeter_8723D	0x1C
...
static int rtw8723d_read_efuse(struct rtw_dev *rtwdev, u8 *log_map)
{
	...
	bool txpwr_valid;
	u8 txpwr_0_vendor[42] = {
		0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x02, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	};
	u8 txpwr_0_1[42] = {
		0x2B, 0x2A, 0x2A, 0x2B, 0x2C, 0x2C, 0x2F, 0x2E, 0x2D, 0x2E, 0x2E, 0x02, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	};
	u8 txpwr_0_2[42] = {
		0x26, 0x25, 0x24, 0x24, 0x24, 0x24, 0x29, 0x28, 0x27, 0x27, 0x27, 0x02, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	};
	u8 txpwr_1_vendor[42] = {
		0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x21, 0x21, 0x21, 0x21, 0x21, 0x02, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	};
	u8 txpwr_def[168] = {
		...
		0x04, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE,
		0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x24, 0xEE, 0xEE, 0xEE, 0xEE,
		0xEE, 0xEE, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A,
		0x04, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE, 0xEE,
		0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x24, 0xEE, 0xEE, 0xEE, 0xEE,
	...
	efuse->rfe_option = EEPROM_DEFAULT_RFE_OPTION;
	...
	memcpy(&(efuse->txpwr_idx_table[0]), txpwr_0_1, sizeof(txpwr_0_1));
	memcpy(&(efuse->txpwr_idx_table[1]), txpwr_1_vendor, sizeof(txpwr_1_vendor));
